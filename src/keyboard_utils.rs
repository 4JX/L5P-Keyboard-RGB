...
#[cfg(target_os = "linux")]
const DEVICE_INFO_2023: (u16, u16, u16, u16) = (0x048d, 0xc984, 0, 0);
#[cfg(target_os = "linux")]
...
const DEVICE_INFO_2023: (u16, u16, u16, u16) = (0x048d, 0xc984, 0xff89, 0x00cc);
#[cfg(target_os = "windows")]
...
pub fn get_keyboard(stop_signal: Arc<AtomicBool>) -> Result<Keyboard, error::Error> {
	...
	let info = api
		...
		.find(|d| {
			...
			info_tuple == DEVICE_INFO_2021 || info_tuple == DEVICE_INFO_2020 || info_tuple == DEVICE_INFO_IDEAPAD_2021 || info_tuple == DEVICE_INFO_2022 || info_tuple == DEVICE_INFO_2023
		})
