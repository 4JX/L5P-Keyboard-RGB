...
impl EffectPlayer for Temperature {
	fn play(manager: &mut super::EffectManager, _direction: crate::enums::Direction, _rgb_array: &[u8; 12], _speed: u8, _brightness: u8, _thread_rng: &mut rand::rngs::ThreadRng) {
		let safe_temp = 30.0;
		let ramp_boost = 1.6;
